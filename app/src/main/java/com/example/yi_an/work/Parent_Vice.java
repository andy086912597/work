...
public class Parent_Vice extends AppCompatActivity {
    private static  String DATABASE_TABLE = "vice";
    private SQLiteDatabase db;
    private MyDBHelper2 dbHelper;
    ...
    private String account="",certification="",vice="",count="",unit="";
    private TextView txttime;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.parent__vice);
        dbHelper = new MyDBHelper2(this);
        ...
        spanner_list.add("蛋黃");
        spanner_list.add("果泥");
        spanner_list.add("蔬菜泥");
        spanner_list.add("豆腐");
        spanner_list.add("洋蔥泥");
        spanner_list.add("蘿蔔泥");
        spanner_list2.add("1");
        spanner_list2.add("2");
        spanner_list2.add("3");
        spanner_list2.add("4");
        ...
        adapter = new ArrayAdapter<String>(Parent_Vice.this,android.R.layout.simple_spinner_item, spanner_list);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setPrompt("下拉菜单");
        spinner.setAdapter(adapter);
        spinner.setOnItemSelectedListener(new SpinnerOnItemSelectListener());

        adapter2 = new ArrayAdapter<String>(Parent_Vice.this,android.R.layout.simple_spinner_item, spanner_list2);
        adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner2.setPrompt("份量");
        spinner2.setAdapter(adapter2);
        spinner2.setOnItemSelectedListener(new SpinnerOnItemSelectListener2());

        adapter3 = new ArrayAdapter<String>(Parent_Vice.this,android.R.layout.simple_spinner_item, spanner_list3);
    ...
    class SpinnerOnItemSelectListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> AdapterView, View view, int position,
            ...
            vice = AdapterView.getItemAtPosition(position).toString();
 ...
 public void btn_addtime(View view)
    {
        new TimePickerDialog(Parent_Vice.this,listener, Calendar.HOUR,Calendar.MINUTE,true).show();
    }
    ...
    public void btn_addvicedb(View view)
    {
        ...
        {}
            ...
            Log.d("123", vice + " " + count + " " + unit);
            Log.d("db", ("新增記錄成功: " + id));
            Intent intent = new Intent();
            intent.setClass(Parent_Vice.this, Parent1.class);
