...
public class MainActivity extends Activity {
	...
	public void btn_savecredit(View view)
	{
		try {
			final CreditCardForm noZipForm = (CreditCardForm) findViewById(R.id.form_no_zip);
			noZipForm.setOnCardValidCallback(cardValidCallback);
			credit=noZipForm.getCreditCard().getCardNumber().toString();
			Log.d("123",credit);
			Context myContext = this.createPackageContext("com.example.yi_an.work", 0);
			Bundle bundle = new Bundle();
			bundle.putString("credit",credit);
			Intent intent = new Intent();
			intent.setPackage("com.example.yi_an.wrok");
			intent.setClassName(myContext, "com.example.yi_an.work.Parent_wallet");
